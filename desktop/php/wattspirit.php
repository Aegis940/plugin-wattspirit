						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{Identifiant}}
									<sup><i class="fas fa-question-circle tooltips" title="{{Renseignez l'identifiant de connexion}}"></i></sup>								
								</label>
								<div class="col-sm-6">
									<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="login" placeholder="{{Identifiant du compte WattSpirit}}"/>
								</div>
							</div>
							<div class="form-group">
...
<?php include_file('desktop', 'wattspirit', 'js', 'wattspirit');?>
